...
hashtags:
  ...
  - GalaxyProject
---
1st in a 4-part BRC-Analytics series on Cyclospora outbreak analysis: what genomes, genotyping panels and sequencing data exist, and how an independent open implementation of the public 8-marker method is built and validated in Galaxy.
